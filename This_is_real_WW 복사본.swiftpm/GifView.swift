...
//    guard let gifLmage + UIImage.gifImageWithName(imageName) else {return}
//
...
//extension UIImage {
//    static func gifImageWithName(_ name: String)-> UIImage? {
//        guard let bundleURL = Bundle.main.url(forResource: name, withExtension: "gif"), let imageData = try? data(contentsOf: bundleURL), let source = CGImageSourceCreateWithURL(imageData as CFData, nil) else { return nil }
//        let count = CGImageSourceGetCount(source)
//        var images = [UIImage]()
//
//        for i in 0..<count {
//            guard let cgImage = CGImageSourceCreateImageAtIndex(source, <#T##index: Int##Int#>, <#T##options: CFDictionary?##CFDictionary?#>)
//        }
//    }
